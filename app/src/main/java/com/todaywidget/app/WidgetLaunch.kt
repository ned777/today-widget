...
/**
 * Both widgets do the exact same thing when tapped — open the PHONE'S OWN
 * default calendar app, to today, the same way tapping iOS's Calendar
 * widgets hands off to the Calendar app rather than opening some other
 * screen. Neither widget manages events itself, so there's no reason to
 * route through our own MainActivity here — this PendingIntent-building
 * boilerplate lives here once instead of being copy-pasted into
 * DateWidgetProvider and MonthWidgetProvider.
 */
object WidgetLaunch {
